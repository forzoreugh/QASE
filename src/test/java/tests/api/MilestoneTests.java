...
public class MilestoneTests extends BaseApiTest {
    ...
    public void getAllMilestones() {
        spec
                .when()
                .get(BASE_URL_QASE + "/milestone/QP")
                .then()
                .log().all()
                .statusCode(200)
    ...
    public void createNewMilestone() {
        ...
        spec
                ...
                .when()
                .post(BASE_URL_QASE + "/milestone/QP")
                .then()
                .log().all()
                .statusCode(200)
                .body("status", equalTo(true));
    ...
    public void getSpecificMilestone() {
        spec
                .when()
                .get(BASE_URL_QASE + "/milestone/QP/4")
                .then()
                .log().all()
                .statusCode(200)
                .body("status", equalTo(true));
    ...
    public void deleteMilestone() {
        spec
                .when()
                .delete(BASE_URL_QASE + "/milestone/QP/4")
                .then()
                .log().all()
                .statusCode(200)
                .body("status", equalTo(true));
    ...
    public void updateMilestone() {
        ...
        spec
                .body(gson.toJson(milestoneModels))
                .when()
                .patch(BASE_URL_QASE + "/milestone/QP/4")
                .then()
                .log().all()
                .statusCode(200)
                .body("status", equalTo(true));
